...
-- insert user
insert into user(id, firstName, lastName, username, role) values (1, 'Dheeraj', 'Karki', "dheerajkarki", 'ROLE_AUTHOR');
insert into user(id, firstName, lastName, username, role) values (2, 'Saurav', 'Shrestha', "sauravshrestha", 'ROLE_AUTHOR');
insert into user(id, firstName, lastName, username, role) values (3, 'Roshan', 'Dhakal', "roshandhakal", 'ROLE_AUTHOR');
insert into user(id, firstName, lastName, username, role) values (4, 'Nabin', 'Karki', "nabinkarki", 'ROLE_AUTHOR');
